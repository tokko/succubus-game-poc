...
_BASE   = r"D:\claude projects\succubus-game-poc\Assets\Characters\Bakeoff\C_HY3DMV"
_TEX_MV  = os.path.join(_BASE, "succubus_textured_vmv.glb")
_SHAPE   = os.path.join(_BASE, "succubus_vmv.glb")
GLB_IN = _TEX_MV if os.path.exists(_TEX_MV) else _SHAPE
HAS_TEXTURE = GLB_IN == _TEX_MV
FBX_OUT = r"D:\claude projects\succubus-game-poc\Assets\Characters\Bakeoff\C_HY3DMV\succubus_c.fbx"
