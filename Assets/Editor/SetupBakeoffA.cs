...
/// </summary>
[InitializeOnLoad]
public static class SetupBakeoffA
{
    // ── Paths ─────────────────────────────────────────────────────────────────
    const string BASE        = "Assets/Characters/Bakeoff/A_HY3D21";
    const string FBX         = BASE + "/succubus_a.fbx";
    ...
    const string MAT         = BASE + "/SuccubusA.mat";
    const string CTRL        = "Assets/Animations/Bakeoff/SuccubusA.controller";
    ...
    [MenuItem("Tools/Setup Bake-off A (HY3D-2.1)")]
